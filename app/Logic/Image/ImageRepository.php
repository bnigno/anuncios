...
class ImageRepository
{
    ...
    public function original( $photo, $filename )
    {
        ...
        $image = $manager->make( $photo )->encode('jpg')->save('/public/upload/' . $filename );
    ...
    {
        $manager = new ImageManager();
        $image = $manager->make( $photo )->encode('jpg')->resize(200, null, function($constraint){$constraint->aspectRatio();})->save( '/public/upload/'  . $filename );
